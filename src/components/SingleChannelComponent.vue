<template>
  <div class="single-channel-component">
               ...
               <nav class="navbar navbar-expand-lg navbar-light">
                  ...
                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                     <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                           <a class="nav-link" href="#">{{ $t("Playlist") }}</a>
                        </li>
                        <li class="nav-item">
                           <a class="nav-link" href="#">{{ $t("Channels") }}</a>
                        </li>
                        <li class="nav-item">
                           <a class="nav-link" href="#">{{ $t("Discussion") }}</a>
                        </li>
                        <li class="nav-item">
                     ...
                     <form class="form-inline my-2 my-lg-0">
                        <input class="form-control form-control-sm mr-sm-1" type="search" placeholder="Search" aria-label="Search"><button class="btn btn-outline-success btn-sm my-2 my-sm-0" type="submit"><i class="fas fa-search"></i></button> &nbsp;&nbsp;&nbsp; <button class="btn btn-outline-danger btn-sm" type="button"> {{ $t("Subscribe") }} <strong>1.4M</strong></button>
                     </form>
                  </div>
               </nav>
            </div>
                  ...
                  <nav aria-label="Page navigation example">
                     <ul class="pagination justify-content-center pagination-sm mb-0">
                        <li class="page-item disabled">
                           <a tabindex="-1" href="#" class="page-link">{{ $t("Previous") }}</a>
                        </li>
...
import {Vue, Component} from 'vue-property-decorator';
  ...
  @Component
  export default class SingleChannelComponent extends Vue {}
</script>