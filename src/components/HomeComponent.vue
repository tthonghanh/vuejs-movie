               ...
               <div class="top-category section-padding mb-4">
                  <div class="row">
                     <div class="col-md-12">
                        ...
                        <div>{{$t('NumberOfProducts', ['3'])}} </div>
                        <div>{{$t('number-of-product-2', { no: '4' })}}</div>
                        <div>{{$tc('number-of-product-3', 0)}}</div>
                        <div>{{$t('date', getDateElement(new Date()))}}</div>
                     </div>
                     <div class="col-md-12">
                        <div class="owl-carousel owl-carousel-category">
                           <div class="item">
                              <div class="category-item">
                                 <a href="#">
                                    <img class="img-fluid" src="../../public/img/s1.png" alt="">
                                    <h6>Your Life</h6>
                                    <p>74,853 {{ $t("views") }}</p>
                                 </a>
                              </div>
                           ...
                           <div class="item">
                              <div class="category-item">
                                 <a href="#">
                                    <img class="img-fluid" src="../../public/img/s2.png" alt="">
                                    <h6>Unboxing Cool</h6>
                                    <p>74,853 {{ $t("views") }}</p>
                                 </a>
                              </div>
                           ...
                           <div class="item">
                              <div class="category-item">
                                 <a href="#">
                                    <img class="img-fluid" src="../../public/img/s3.png" alt="">
                           ...
                           <div class="item">
                              <div class="category-item">
                                 <a href="#">
                                    <img class="img-fluid" src="../../public/img/s4.png" alt="">
                           ...
                           <div class="item">
                              <div class="category-item">
                                 <a href="#">
                                    <img class="img-fluid" src="../../public/img/s5.png" alt="">
                           ...
                           <div class="item">
                              <div class="category-item">
                                 <a href="#">
                                    <img class="img-fluid" src="../../public/img/s6.png" alt="">
                                    <h6>Singing</h6>
                                    <p>74,853 {{ $t("views") }}</p>
                                 </a>
                              </div>
                           ...
                           <div class="item">
                              <div class="category-item">
                                 <a href="#">
                                    <img class="img-fluid" src="../../public/img/s7.png" alt="">
                                    <h6>Cooking</h6>
                                    <p>74,853 {{ $t("views") }}</p>
                                 </a>
                              </div>
                           ...
                           <div class="item">
                              <div class="category-item">
                                 <a href="#">
                                    <img class="img-fluid" src="../../public/img/s8.png" alt="">
                                    <h6>Traveling</h6>
                                    <p>74,853 {{ $t("views") }}</p>
                                 </a>
                              </div>
                  ...
                  <div class="row">
                     <div class="col-md-12">
                        <div class="main-title">
                           <div class="btn-group float-right right-action">
                              <a href="#" class="right-action-link text-gray" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              {{ $t("sort-by") }}<i class="fa fa-caret-down" aria-hidden="true"></i>
                              </a>
                              <div class="dropdown-menu dropdown-menu-right">
                                 <a class="dropdown-item" href="#"><i class="fas fa-fw fa-star"></i> &nbsp; Top Rated</a>
                                 <a class="dropdown-item" href="#"><i class="fas fa-fw fa-signal"></i> &nbsp; Viewed</a>
                        ...
                        <div class="video-card">
                           ...
                           <div class="video-card-body">
                              ...
                              <div class="video-view">
                                 1.8M {{ $t("views") }} &nbsp;<i class="fas fa-calendar-alt"></i> 11 Months ago
                              </div>
                           </div>
                        </div>
                     </div>
                  ...
                  <div class="row">
                     <div class="col-md-12">
                        <div class="main-title">
                           ...
                           <h6>{{ $t("popular-channels") }}</h6>
                        </div>
                     </div>
                     <div class="col-xl-3 col-sm-6 mb-3">
                        <div class="channels-card">
                           <div class="channels-card-image">
                              <a href="#"><img class="img-fluid" src="../../public/img/s1.png" alt=""></a>
                              <div class="channels-card-image-btn"><button type="button" class="btn btn-outline-danger btn-sm"> {{ $t("Subscribe") }} <strong>1.4M</strong></button></div>
                           </div>
                     ...
                     <div class="col-xl-3 col-sm-6 mb-3">
                        <div class="channels-card">
                           <div class="channels-card-image">
                              <a href="#"><img class="img-fluid" src="../../public/img/s2.png" alt=""></a>
                              <div class="channels-card-image-btn"><button type="button" class="btn btn-outline-danger btn-sm"> {{ $t("Subscribe") }} <strong>1.4M</strong></button></div>
                           </div>
                           <div class="channels-card-body">
                              <div class="channels-title">
                     ...
                     <div class="col-xl-3 col-sm-6 mb-3">
                        <div class="channels-card">
                           <div class="channels-card-image">
                              <a href="#"><img class="img-fluid" src="../../public/img/s3.png" alt=""></a>
                     ...
                     <div class="col-xl-3 col-sm-6 mb-3">
                        <div class="channels-card">
                           <div class="channels-card-image">
                              <a href="#"><img class="img-fluid" src="../../public/img/s4.png" alt=""></a>
                              <div class="channels-card-image-btn"><button type="button" class="btn btn-outline-danger btn-sm"> {{ $t("Subscribe") }} <strong>1.4M</strong></button></div>
                           </div>
                           <div class="channels-card-body">
                              <div class="channels-title">
...
import { getDateElement } from '../utils/helper'
...
export default class HomeComponent extends Vue {
   ...
   getDateElement(date: Date) {
      return getDateElement(date);
   }
   async created() {
      this.movies = await this.movieRepository.getMovies();
